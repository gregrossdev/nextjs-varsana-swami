        ...
        <Container >
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className={`me-auto ${styles.menus}`}>
              ...
              <NavDropdown title="Writings" id="basic-nav-dropdown" className={styles.menuItems}>
                <NavDropdown.Item eventKey="2">
                  <Link href="earth-culture/sacramental-nature-of-agriculture-and-plow">Earth Culture</Link>
                </NavDropdown.Item>
                <NavDropdown.Item eventKey="2">
                  <Link href="/festivals/rope-meditation">Festivals</Link>
                </NavDropdown.Item>
                <NavDropdown.Item eventKey="2">
                  <Link href="/going-deeper/relationship-with-self-and-lord-s-measuring-stick">Going Deeper</Link>
                </NavDropdown.Item>
                <NavDropdown.Item eventKey="2">
                  <Link href="/gaura-katha/lord-caitanya-s-taking-sanyas-and-mother-saci">Gaura Katha</Link>
                </NavDropdown.Item>
                <NavDropdown.Item eventKey="2">
                  <Link href="/nature-meditations/light-of-the-bhagavat-transcendental-lessons-from-the-natural-world">Nature Meditations</Link>
                </NavDropdown.Item>
                <NavDropdown.Item eventKey="2">
                  <Link href="/personalities/the-story-of-bhakti-devi">Personalities</Link>
                </NavDropdown.Item>
                <NavDropdown.Item eventKey="2">
                  <Link href="/srila/i-will-never-die-i-will-live-forever-in-my-books.">Srila Prabhupada Katha</Link>
                </NavDropdown.Item>
                <NavDropdown.Item eventKey="2">
                  <Link href="/sadhu-sanga/acaryas-their-grace-their-samadhis-and-our-hope">Sadhu-Sanga</Link>
                </NavDropdown.Item>
                <NavDropdown.Item eventKey="2">
                  <Link href="/sri-dhama/survey-on-govardhan-hill-in-new-vrindaban">Sri Dhama</Link>
                </NavDropdown.Item>
                <NavDropdown.Item eventKey="2">
                  <Link className="white-space" href="/vyasa-puja/vyasa-puja-offering-2021">
